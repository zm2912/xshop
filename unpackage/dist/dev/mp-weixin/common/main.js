...
/***/ 0:
/*!************************************************!*\
  !*** D:/项目/uni-app项目/商城/xshop-uni-app/main.js ***!
  \************************************************/
...
var _index = __webpack_require__(/*! @/common/request/index.js */ 12);
var _parseHtml = _interopRequireDefault(__webpack_require__(/*! @/common/parseHtml.js */ 39));
var _tools = _interopRequireDefault(__webpack_require__(/*! @/common/tools */ 20));
var _merouter = _interopRequireDefault(__webpack_require__(/*! @/common/merouter */ 40));



var _index2 = _interopRequireDefault(__webpack_require__(/*! @/common/request/apis/index */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
_vue.default.use(new _index.HttpWidget());
...
_vue.default.prototype.$parseHtml = _parseHtml.default;
_vue.default.prototype.$tools = _tools.default;
_vue.default.prototype.$meRouter = _merouter.default;
...
/***/ 25:
/*!************************************************!*\
  !*** D:/项目/uni-app项目/商城/xshop-uni-app/App.vue ***!
  \************************************************/
/*! no static exports found */
...
component.options.__file = "uni-app项目/商城/xshop-uni-app/App.vue"
...
/***/ 26:
/*!*************************************************************************!*\
  !*** D:/项目/uni-app项目/商城/xshop-uni-app/App.vue?vue&type=script&lang=js& ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 27:
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/项目/uni-app项目/商城/xshop-uni-app/App.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  (0, _vuex.mapMutations)(['SAVE_USERINFO']), {
    appUpdate: function appUpdate(downloadResult) {
    ...
    login: function login() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var account, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:

                account = _Account.default.init('WechatMp');
                console.log(uni.getStorageSync('openId'), "uni.getStorageSync('openId')");_context.t0 =
                !uni.getStorageSync('openId');if (_context.t0) {_context.next = 7;break;}_context.next = 6;return account.isLogin();case 6:_context.t0 = !_context.sent;case 7:if (!_context.t0) {_context.next = 13;break;}_context.next = 10;return (
                  account.login2());case 10:res = _context.sent;
                if (res.data.openid) uni.setStorageSync('openId', res.data.openid);
                if (res.data.userinfo) {
                  uni.setStorageSync('token', res.data.userinfo.token);
                  _this.SAVE_USERINFO(res.data.userinfo);
                }case 13:case "end":return _context.stop();}}}, _callee);}))();


    },
    getAppId: function getAppId() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var code, res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (
                ...
                !code) {_context2.next = 8;break;}_context2.next = 6;return (
                  _this2.fetchAppId(code));case 6:res = _context2.sent;return _context2.abrupt("return",
                Promise.resolve(res));case 8:return _context2.abrupt("return",

                Promise.reject());case 9:case "end":return _context2.stop();}}}, _callee2);}))();

    },
    fetchAppId: function fetchAppId(code) {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var res;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (
                  _this3.$http.post('index.config', {
  ...
  onLaunch: function () {var _onLaunch = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
              ...
              this.getAppInfo();
              this.getUserinfo().catch(function (e) {});
              this.launchLog();
              this.getAppId().then(function (res) {

              }).catch(function (e) {});
              this.getAppInfo();case 6:case "end":return _context4.stop();}}}, _callee4, this);}));function onLaunch() {return _onLaunch.apply(this, arguments);}return onLaunch;}(),
...
/***/ 36:
/*!**********************************************************************************!*\
  !*** D:/项目/uni-app项目/商城/xshop-uni-app/App.vue?vue&type=style&index=0&lang=scss& ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 37:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/项目/uni-app项目/商城/xshop-uni-app/App.vue?vue&type=style&index=0&lang=scss& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
